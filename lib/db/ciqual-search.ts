...
function mapToIngredientCiqual(aliment: CiqualRow): Omit<IngredientCiqual, 'id' | 'date_import'> {
  ...
  return {
    ...
    nutrition_100g: {
      ...
      acides_gras_satures_g: parseNumericValue(aliment['AG saturés (g/100 g)']),
      acides_gras_monoinsatures_g: parseNumericValue(aliment['AG monoinsaturés (g/100 g)']),
      acides_gras_polyinsatures_g: parseNumericValue(aliment['AG polyinsaturés (g/100 g)']),
