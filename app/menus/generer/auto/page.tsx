...
import { Wand2, Calendar, Save, Download, ShoppingCart, RefreshCw, ArrowLeft } from "lucide-react";
...
export default function GenererMenusAutoPage() {
  ...
  if (profileLoading) {
    return (
      <MainLayout title="Génération Automatique">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              Générer automatiquement 7 jours de menus
            </CardTitle>
            <CardDescription>
              L'IA génère automatiquement une semaine complète basée sur votre profil et les aliments disponibles
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            {/* Infos profil */}
            <div className="p-4 bg-blue-50 dark:bg-blue-950/20 rounded-lg border border-blue-200 dark:border-blue-800">
              <h3 className="font-semibold text-sm mb-2">Informations de votre profil</h3>
